...
{
	$title = Regions::is_region() ? str_replace(" #region_case#", " â " . Regions::get_name_case_region(5), htmlspecialcharsex($arResult[$index]["TITLE"])) : str_replace(" #region_case#", "", htmlspecialcharsex($arResult[$index]["TITLE"]));

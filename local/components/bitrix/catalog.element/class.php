...
class CatalogElementComponent extends Element
{
	...
	protected function initMetaData()
    {
        ...
        {
            $APPLICATION->SetTitle(Regions::is_region() ? str_replace(" #region_case#", " â " . Regions::get_name_case_region(5), $arResult["META_TAGS"]["TITLE"]) : str_replace(" #region_case#", "", $arResult["META_TAGS"]["TITLE"]), $this->storage['TITLE_OPTIONS']);
        ...
        if ($this->arParams['SET_BROWSER_TITLE'] === 'Y')
        {
            ...
            {
                $APPLICATION->SetPageProperty("title", Regions::is_region() ? str_replace(" #region_case#", " â " . Regions::get_name_case_region(5), $arResult["META_TAGS"]["BROWSER_TITLE"]) : str_replace(" #region_case#", "", $arResult["META_TAGS"]["BROWSER_TITLE"]), $this->storage['TITLE_OPTIONS']);
            }
        ...
        if ($this->arParams['SET_META_KEYWORDS'] === 'Y')
        {
            ...
            {
                $APPLICATION->SetPageProperty("keywords", $arResult["META_TAGS"]["KEYWORDS"].(Regions::is_region() ? " â " . Regions::get_name_case_region(5) : ""), $this->storage['TITLE_OPTIONS']);
            }
        }
        ...
        if ($this->arParams['SET_META_DESCRIPTION'] === 'Y')
        {
            ...
            {
                $APPLICATION->SetPageProperty("description", Regions::is_region() ? str_replace(" #region_case#", " â " . Regions::get_name_case_region(5), $arResult["META_TAGS"]["DESCRIPTION"]) : str_replace(" #region_case#", "", $arResult["META_TAGS"]["DESCRIPTION"]), $this->storage['TITLE_OPTIONS']);
            }
        }

...
<?$res = CIBlockSection::GetList(Array(), Array("IBLOCK_ID" => 23, "CODE" => $arResult['VARIABLES']['SECTION_CODE']), false, Array("UF_COMMUN"));
if($arRes = $res->Fetch()){$SECTION_ID = $arRes['UF_COMMUN'];}?>
...
$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"IBLOCK_ID" => 12,
		"IBLOCK_SECTION_CODE" => $arResult['VARIABLES']['SECTION_CODE'],
		...
		"SECTION_URL" => "/catalog/".$arResult['URL_TEMPLATES']['section'],

...
<? if ($APPLICATION->GetCurPage() == "/catalog/index.php" || $APPLICATION->GetCurPage() == "/mcatalog/index.php"): ?>
    <h1>Каталог трансформаторной продукции</h1><? endif; ?>
<?
        ...
        if ($CURRENT_DEPTH >= $arSection["DEPTH_LEVEL"]):?>
            <div class="catElement product col-xs-6 col-sm-6 col-md-4 col-lg-3">
                <div class="catElementNested">
                    <div class="name"><a href="<?= $arSection["SECTION_PAGE_URL"] ?>"><?= $arSection["NAME"] ?></a>
                    </div>
                    <div class="separator"></div>
                    <div class="img"><a href="<?= $arSection["SECTION_PAGE_URL"] ?>"><img
                                    src='<?= CFile::ResizeImageGet($arSection["PICTURE"], array('width' => 1500000000, 'height' => 100), BX_RESIZE_IMAGE_PROPORTIONAL, true)['src']; ?>'></a>
                    </div>
                    <div class="detailed"><a class="section_detailed" href="<?= $arSection["SECTION_PAGE_URL"] ?>">Подробнее</a>
                    </div>
                </div>
            </div>
        <? endif; ?>

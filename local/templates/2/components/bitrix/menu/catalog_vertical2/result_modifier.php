...
if (CModule::IncludeModule("iblock"))
{
	...
	elseif ($obCache->StartDataCache())
	{
		...
		{
			$dbSections = CIBlockSection::GetList(array(), array("IBLOCK_ID" => $arIBlock["ID"]), false, array("ID", "SECTION_PAGE_URL", "PICTURE", "DESCRIPTION", "UF_LOGO_SECTION", "UF_LOGO_SECTION_HOVER"));
			while($arSections = $dbSections->GetNext())
			{
				...
				$arSectionsInfo[crc32($arSections["SECTION_PAGE_URL"])]["UF_LOGO_SECTION"] = $arSections["UF_LOGO_SECTION"];
				$arSectionsInfo[crc32($arSections["SECTION_PAGE_URL"])]["UF_LOGO_SECTION_HOVER"] = $arSections["UF_LOGO_SECTION_HOVER"];
			}
...
foreach($arResult as $arItem)
{
	...
	$arItem["PARAMS"]["UF_LOGO_SECTION"] = $arSectionsInfo[$arItem["PARAMS"]["item_id"]]["UF_LOGO_SECTION"];
	$arItem["PARAMS"]["UF_LOGO_SECTION_HOVER"] = $arSectionsInfo[$arItem["PARAMS"]["item_id"]]["UF_LOGO_SECTION_HOVER"];

...
<? if (!empty($arResult)): ?>
    ...
    <? foreach ($arResult as &$menu_item): ?>
        ...
        <? if ($menu_item['IS_PARENT'] == 1): ?>
            ...
            <a data-toggle="dropdown" class="dropdown-toggle-js"
               href="<?= $menu_item['LINK'] ?>"><?= $menu_item['TEXT'] ?></a>
        ...
        <? elseif ($menu_item['IS_PARENT'] != 1 && $menu_item['DEPTH_LEVEL'] == 1): ?>
            ...
            <li <? if ($menu_item['SELECTED'] == 1): echo 'class="active"'; endif; ?>><a
                        href="<?= $menu_item['LINK'] ?>"><?= $menu_item['TEXT'] ?></a></li>
